...
- akka-testkit 2.0.x (with 'provided' scope, i.e. you need to pull it in yourself)
...
__ https://github.com/spray/spray/tree/release/1.0/spray-routing-tests/src/test/scala/spray/routing